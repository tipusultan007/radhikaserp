@extends('layouts.vertical', ['page_title' => 'Edit Warehouse', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <div class="container-fluid">
         ...
         <div class="row">
             <div class="col-lg-8">
                 <div class="card">
                     <div class="card-body">
                         <h4 class="header-title mb-3">Update Warehouse Details</h4>
                         ...
                         <form action="{{ route('warehouses.update', $warehouse->id) }}" method="POST">
                             ...
                             <div class="mb-3">
                                 ...
                                 <input type="text" id="code" name="code" class="form-control" value="{{ old('code', $warehouse->code) }}" required>
                             </div>

                             <div class="mb-3">
                                 <label for="address" class="form-label">Address</label>
                                 <textarea id="address" name="address" class="form-control" rows="3">{{ old('address', $warehouse->address) }}</textarea>
                             </div>
                             ...
                             <div class="mb-3">
                                 <div class="form-check form-switch">
                                     <input type="checkbox" class="form-check-input" id="status" name="status" value="1" {{ old('status', $warehouse->status) ? 'checked' : '' }}>
                                     <label class="form-check-label" for="status">Active Status</label>
                                 </div>
                             </div>

                             <div class="mt-4">
                                 <button type="submit" class="btn btn-primary me-1">Update Warehouse</button>
