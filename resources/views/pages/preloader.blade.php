...
<head>
    ...
    @vite(['resources/js/head.js', 'node_modules/daterangepicker/daterangepicker.css', 'node_modules/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css'])
</head>
...
<body>
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <div class="leftbar-user">
                    <a href="{{ route('second', ['pages', 'profile']) }}">
                        ...
                        <span class="leftbar-user-name mt-2">Doris Larson</span>
                    </a>
                </div>
    ...
    @vite(['resources/js/app.js', 'resources/js/layout.js', 'resources/js/pages/demo.dashboard.js'])
