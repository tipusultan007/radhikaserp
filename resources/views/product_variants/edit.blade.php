                         ...
                         <form action="{{ route('product-variants.update', $productVariant->id) }}" method="POST">
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <select id="unit_id" name="unit_id" class="form-select select2" data-toggle="select2" required>
                                             ...
                                             @foreach($units as $unit)
                                                 <option value="{{ $unit->id }}" {{ old('unit_id', $productVariant->unit_id) == $unit->id ? 'selected' : '' }}>
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-4 mb-3">
                                     ...
                                     <input type="number" step="any" id="dealer_price" name="dealer_price" class="form-control" placeholder="e.g. 23.00" value="{{ old('dealer_price', $productVariant->dealer_price) }}">
                                 </div>
                                 <div class="col-md-4 mb-3">
                                     <label for="special_dealer_price" class="form-label">Special Dealer Price</label>
                                     <input type="number" step="any" id="special_dealer_price" name="special_dealer_price" class="form-control" placeholder="e.g. 21.00" value="{{ old('special_dealer_price', $productVariant->special_dealer_price) }}">
                                 </div>
                             </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        function loadUnits() {
            ...
            let oldUnitId = "{{ old('unit_id', $productVariant->unit_id) }}";
