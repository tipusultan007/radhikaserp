@extends('layouts.vertical', ['page_title' => 'Edit Product', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <div class="container-fluid">
         <div class="row">
            <div class="col-12">
                <div class="page-title-box justify-content-between d-flex align-items-md-center flex-md-row flex-column">
                    <h4 class="page-title">Edit Master Product</h4>
         ...
         <div class="row">
             <div class="col-lg-8">
                 <div class="card">
                     <div class="card-body">
                         <h4 class="header-title mb-3">Update Product Specifications</h4>
                         ...
                         <form action="{{ route('products.update', $product->id) }}" method="POST">
                             ...
                             <div class="mb-3">
                                 ...
                                 <select id="type" name="type" class="form-control" required>
                                     <option value="raw" {{ old('type', $product->type) === 'raw' ? 'selected' : '' }}>Raw Stock</option>
                                     <option value="finished" {{ old('type', $product->type) === 'finished' ? 'selected' : '' }}>Finished Goods</option>
                                 </select>
                             </div>
                             ...
                             <div class="mt-4">
                                 <button type="submit" class="btn btn-primary me-1">Update Product</button>
