@extends('layouts.vertical', ['page_title' => 'New Repackaging Order', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    <div class="container-fluid">
         <div class="row">
            <div class="col-12">
                <div class="page-title-box justify-content-between d-flex align-items-md-center flex-md-row flex-column">
                    <h4 class="page-title">New Repackaging Order</h4>
         ...
         <form action="{{ route('repackaging.store') }}" method="POST" id="repackagingForm">
             @csrf
                 ...
                 <div class="col-12">
                     <div class="card shadow-sm border-0">
                                 ...
                                 <div class="col-md-6">
                                     <div class="mb-3">
                                         ...
                                         <div class="input-group">
                                             ...
                                             <input type="number" step="1" min="0" name="expenses" class="form-control" value="0.00">
                                         </div>
                         ...
                         <div class="card-footer bg-white border-top text-end py-3">
                             ...
                             <button type="submit" class="btn btn-primary" id="submitBtn"><i class="ri-save-line"></i> Confirm & Execute Conversion</button>
                         </div>
                     </div>
                 </div>
             </div>
...
$(document).ready(function() {
    ...
    $('#repackagingForm').submit(function() {
        $('#submitBtn').prop('disabled', true).html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Executing...');
    });
});
</script>
@endsection
