                                ...
                                @if(isset($openingBalance) && $openingBalance != 0)
                                    <tr class="bg-light">
                                        @if($openingBalance > 0)
                                            ...
                                            <td class="border-end text-end text-success fw-bold">{{ number_format($openingBalance, 0) }}</td>
                                            <td></td><td></td><td></td>
                                        @else
                                            <td></td><td></td><td class="border-end"></td>
                                            <td class="fw-bold">{{ \Carbon\Carbon::parse($date)->format('d M, Y') }}</td>
                                            <td class="fw-bold">By Balance b/d</td>
                                            <td class="text-end text-danger fw-bold">{{ number_format(abs($openingBalance), 0) }}</td>
                                        @endif
                                    </tr>
                                @endif
